...
const MOB_ENCOUNTERS = [
  { atGate: 3, threshold: 6,  scale: 0.68, vz: 0.30, tint: 0xC9A385, damage: 22 }, // le chiot du voisin
  { atGate: 6, threshold: 13, scale: 0.86, vz: 0.24, tint: 0xA3846B, damage: 34 }, // un chien errant
];
